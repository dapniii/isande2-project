...
export const jobOrderAPI = {
    ...
    return_items: `/api/joborders/transactions/returnItems`,
    approve: `/api/joborders/transactions/approve`,
    request_review: `/api/joborders/transactions/requestReview`,
    handover_items: `/api/joborders/transactions/handoverItems`,
}
...
export const reportAPI = {
    generate_inventory_report: `${process.env.NEXT_PUBLIC_API_BASE_URL}/api/reports/allItemsReport`,
    generate_joborder_report: `${process.env.NEXT_PUBLIC_API_BASE_URL}/api/reports/jobOrderReport`,
    generate_purchaseorder_report: `${process.env.NEXT_PUBLIC_API_BASE_URL}/api/reports/purchaseOrderReport`,
    generate_fuel_out_report: `${process.env.NEXT_PUBLIC_API_BASE_URL}/api/reports/fuelOutReport`,
    generate_fuel_in_report: `${process.env.NEXT_PUBLIC_API_BASE_URL}/api/reports/fuelInReport`,
}